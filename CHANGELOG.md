...
- chore(deps-dev): bump @types/react from 18.2.56 to 18.2.61 in /site ([#986](https://github.com/VeryGoodOpenSource/very_good_cli/pull/986))
- chore(deps): bump peter-evans/create-pull-request from 6.0.0 to 6.0.1 ([#978](https://github.com/VeryGoodOpenSource/very_good_cli/pull/978))
- chore(deps-dev): bump eslint from 8.56.0 to 8.57.0 in /site ([#970](https://github.com/VeryGoodOpenSource/very_good_cli/pull/970))
- chore(deps): bump pana from 0.22.1 to 0.22.2 ([#980](https://github.com/VeryGoodOpenSource/very_good_cli/pull/980))
- chore(deps): bump VeryGoodOpenSource/very_good_coverage ([#988](https://github.com/VeryGoodOpenSource/very_good_cli/pull/988))
- chore(deps-dev): bump @types/react from 18.2.61 to 18.2.64 in /site ([#990](https://github.com/VeryGoodOpenSource/very_good_cli/pull/990))
- chore(deps-dev): bump typescript from 5.3.3 to 5.4.2 in /site ([#991](https://github.com/VeryGoodOpenSource/very_good_cli/pull/991))
- chore(deps): bump peter-evans/create-pull-request from 6.0.1 to 6.0.2 ([#992](https://github.com/VeryGoodOpenSource/very_good_cli/pull/992))
- chore(deps-dev): bump @types/react from 18.2.64 to 18.2.66 in /site ([#995](https://github.com/VeryGoodOpenSource/very_good_cli/pull/995))
- chore: update SPDX licenses ([#994](https://github.com/VeryGoodOpenSource/very_good_cli/pull/994))
- chore(deps-dev): bump @babel/eslint-parser in /site ([#999](https://github.com/VeryGoodOpenSource/very_good_cli/pull/999))
- chore(deps-dev): bump typescript from 5.4.2 to 5.4.3 in /site ([#1000](https://github.com/VeryGoodOpenSource/very_good_cli/pull/1000))
- chore(deps-dev): bump @types/react from 18.2.66 to 18.2.70 in /site ([#1001](https://github.com/VeryGoodOpenSource/very_good_cli/pull/1001))
- chore: update SPDX licenses ([#1003](https://github.com/VeryGoodOpenSource/very_good_cli/pull/1003))
- chore(deps): bump @docusaurus/core from 3.1.1 to 3.2.0 in /site ([#1007](https://github.com/VeryGoodOpenSource/very_good_cli/pull/1007))
- feat: add `--dart-define-from-file` support ([#984](https://github.com/VeryGoodOpenSource/very_good_cli/pull/984))
- chore(deps-dev): bump @docusaurus/eslint-plugin from 3.2.0 to 3.2.1 in /site ([#1012](https://github.com/VeryGoodOpenSource/very_good_cli/pull/1012))
- chore(deps): bump peaceiris/actions-gh-pages from 3 to 4 ([#1015](https://github.com/VeryGoodOpenSource/very_good_cli/pull/1015))
- chore: update SPDX licenses ([#1017](https://github.com/VeryGoodOpenSource/very_good_cli/pull/1017))
- chore(deps): bump peter-evans/create-pull-request from 6.0.2 to 6.0.3 ([#1018](https://github.com/VeryGoodOpenSource/very_good_cli/pull/1018))
- chore(deps-dev): bump typescript from 5.4.3 to 5.4.5 in /site ([#1019](https://github.com/VeryGoodOpenSource/very_good_cli/pull/1019))
- chore(deps-dev): bump @types/react from 18.2.70 to 18.2.78 in /site ([#1020](https://github.com/VeryGoodOpenSource/very_good_cli/pull/1020))
- chore: update SPDX licenses ([#1021](https://github.com/VeryGoodOpenSource/very_good_cli/pull/1021))
- chore(deps): bump peter-evans/create-pull-request from 6.0.3 to 6.0.4 ([#1022](https://github.com/VeryGoodOpenSource/very_good_cli/pull/1022))
- chore(deps): bump pana from 0.22.2 to 0.22.3 ([#1023](https://github.com/VeryGoodOpenSource/very_good_cli/pull/1023))
- chore(deps-dev): bump @types/react from 18.2.78 to 18.2.79 in /site ([#1026](https://github.com/VeryGoodOpenSource/very_good_cli/pull/1026))
