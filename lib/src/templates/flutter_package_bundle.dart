...
final flutterPackageBundle = MasonBundle.fromJson({
  "files": [
    {
      "path": ".gitignore",
      "data":
    ...
    {
      "path": "{{project_name}}/test/{{project_name}}_test.dart",
      "data":
    ...
    {
      "path": "{{project_name}}/pubspec.yaml",
      "data":
    ...
    {
      "path": "{{project_name}}/analysis_options.yaml",
      "data":
