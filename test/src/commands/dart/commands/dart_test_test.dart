  ...
  group('dart test', () {
    ...
    test(
      ...
      () async {
        ...
        verify(() => logger.err(any(that: contains('--recursive')))).called(1);
      },
    );
    ...
    group('very_good.yaml configuration', () {
      ...
      test('CLI argument takes precedence over config value', () {
        ...
        final options = DartTestOptions.parse(
          ...
          config: const VeryGoodConfig(
            dart: VeryGoodDartConfig(
              test: VeryGoodDartTestConfig(minCoverage: '90'),
            ),
          ),
        );
      ...
      test('CLI --file-reporter takes precedence over config value', () {
        ...
        final options = DartTestOptions.parse(
          ...
          config: const VeryGoodConfig(
            dart: VeryGoodDartConfig(
              test: VeryGoodDartTestConfig(fileReporter: 'json:config.json'),
            ),
          ),
        );
